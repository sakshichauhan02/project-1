...
export default function AiPrototypesPage() {
  ...
  // Define subtle offset limits relative to window scroll position (starts at 0 when at top)
  const y1 = useTransform(scrollY, [0, 800], [0, -15]);
  const y2 = useTransform(scrollY, [0, 800], [0, 20]);
  const y3 = useTransform(scrollY, [0, 800], [0, -30]);
  const y4 = useTransform(scrollY, [0, 800], [0, 15]);
  const y5 = useTransform(scrollY, [0, 800], [0, -25]);
  const y6 = useTransform(scrollY, [0, 800], [0, 30]);

  // Disable movement if reduced motion preference is enabled and component is mounted
  const yOffset1 = mounted && shouldReduceMotion ? 0 : y1;
  const yOffset2 = mounted && shouldReduceMotion ? 0 : y2;
  const yOffset3 = mounted && shouldReduceMotion ? 0 : y3;
  const yOffset4 = mounted && shouldReduceMotion ? 0 : y4;
  const yOffset5 = mounted && shouldReduceMotion ? 0 : y5;
  const yOffset6 = mounted && shouldReduceMotion ? 0 : y6;
    ...
    <div className="flex-grow bg-white py-24 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <FadeIn delay={100} className="md:col-span-2">
          <motion.div style={{ y: yOffset1 }} className="h-full">
        ...
        <FadeIn delay={150}>
          <motion.div style={{ y: yOffset2 }} className="h-full">
            <SpotlightCard className="min-h-[320px]">
              <div>
                <div className="flex justify-between items-start mb-6">
        ...
        <FadeIn delay={200} className="md:row-span-2">
          <motion.div style={{ y: yOffset3 }} className="h-full">
        ...
        <FadeIn delay={250}>
          <motion.div style={{ y: yOffset4 }} className="h-full">
        ...
        {/* Card 5: Interactive Terminal (Col Span 1, Row Span 1) */}
        <FadeIn delay={300}>
          <motion.div style={{ y: yOffset5 }} className="h-full">
            <SpotlightCard className="min-h-[300px]">
              <div>
                <div className="flex justify-between items-start mb-6">
                ...
                <h3 className="text-xl font-bold text-zinc-950 mb-2">API Terminal</h3>
                <p className="text-xs text-zinc-400 font-medium uppercase tracking-wider mb-4">Workflow Execution Logs</p>
              </div>
        ...
        <FadeIn delay={350} className="md:col-span-2">
          <motion.div style={{ y: yOffset6 }} className="h-full">
